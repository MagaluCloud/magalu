...
type RestoreParametersNetworkInterfaceSecurityGroupsItem struct {
	Id             string                                                             `json:"id"`
	Name           *string                                                            `json:"name,omitempty"`
	SecurityGroups *RestoreParametersNetworkInterfaceSecurityGroupsItemSecurityGroups `json:"security_groups,omitempty"`
}

type RestoreParametersNetworkInterfaceSecurityGroupsItemSecurityGroups []RestoreParametersNetworkInterfaceSecurityGroupsItem
...
func (s *service) Restore(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Restore", mgcCore.RefPath("/virtual-machine-xaas/xaas backups/restore"), s.client, s.ctx)
	if err != nil {
		return
	}
