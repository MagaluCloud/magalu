...
Delete a register image from Virtual Machine DB.
...
func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/virtual-machine-xaas/images/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/virtual-machine-xaas/images/delete"), s.client)
	if err != nil {
		return
	}
