...
# Lists all instances in the current tenant for xaas project
...
func (s *service) List(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("List", mgcCore.RefPath("/virtual-machine-xaas/xaas instances/list"), s.client, s.ctx)
	if err != nil {
		return
	}
