...
# Delete a instance asynchronously in a xaas project
...
func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/virtual-machine-xaas/xaas instances/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/virtual-machine-xaas/xaas instances/delete"), s.client)
	if err != nil {
		return
	}
