...
Starts a Virtual Machine instance with the id provided in the current
...
func (s *service) Start(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Start", mgcCore.RefPath("/virtual-machine-xaas/xaas instances/start"), s.client, s.ctx)
	if err != nil {
		return
	}
