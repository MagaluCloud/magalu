...
# Delete Public IP XaaS

# Description

Delete a Public IP from the provided tenant_id for xaas
...
func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/network/xaas_public_ip/public-ips/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/network/xaas_public_ip/public-ips/delete"), s.client)
	if err != nil {
		return
	}
