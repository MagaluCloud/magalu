...
/*func (s *service) Get(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Get", mgcCore.RefPath("/network/security_group/security-groups/get"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) GetContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Get", mgcCore.RefPath("/network/security_group/security-groups/get"), s.client, ctx)
	if err != nil {
		return
	}
