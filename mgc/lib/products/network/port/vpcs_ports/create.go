...
/*func (s *service) Create(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Create", mgcCore.RefPath("/network/port/vpcs-ports/create"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) CreateContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Create", mgcCore.RefPath("/network/port/vpcs-ports/create"), s.client, ctx)
	if err != nil {
		return
	}
