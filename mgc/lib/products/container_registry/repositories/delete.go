...
Delete a container registry repository by repository_name.
...
/*func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/container-registry/repositories/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/container-registry/repositories/delete"), s.client, ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/container-registry/repositories/delete"), s.client)
	if err != nil {
		return
	}
