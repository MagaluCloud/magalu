...
/*func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/virtual-machine/backups/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/virtual-machine/backups/delete"), s.client, ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/virtual-machine/backups/delete"), s.client)
	if err != nil {
		return
	}
