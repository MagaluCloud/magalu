...
/*func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/object-storage/buckets/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/object-storage/buckets/delete"), s.client, ctx)
	if err != nil {
		return
	}
