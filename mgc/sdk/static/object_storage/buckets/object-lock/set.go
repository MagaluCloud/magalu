...
func setObjectLocking(ctx context.Context, params setBucketACLParams, cfg common.Config) (result core.Value, err error) {
...
func newSetBucketObjectLockingRequest(ctx context.Context, p setBucketACLParams, cfg common.Config) (*http.Request, error) {
	...
	getBody := func() (io.ReadCloser, error) {
		bodyObj := defaultObjectLockingBody
		if p.Days != 0 {
			bodyObj.Rule.DefaultRetention.Days = p.Days
		} else {
			bodyObj.Rule.DefaultRetention.Years = p.Years
		}
