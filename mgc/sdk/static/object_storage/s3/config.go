...
type Config struct {
	...
	MaxWorkers  int    `json:"max_workers,omitempty" jsonschema:"description=Max workers used to concurrently execute jobs from the queue. Should be less than queue_size,default=10,"`
	QueueSize   int64  `json:"queue_size,omitempty" jsonschema:"description=Size of the queue of jobs used to recursively delete files. Should be larger than max_workers,default=1000"`
}
