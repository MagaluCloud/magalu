...
type GetBucketObjectLockParams struct {
	Object common.ObjectError `json:"dst" jsonschema:"description=Specifies the object whose ACL is being requested" mgc:"positional"`
}
...
func getObjectLocking(ctx context.Context, params GetBucketObjectLockParams, cfg common.Config) (result common.AccessControlPolicy, err error) {

	objectURI := mgcSchemaPkg.URI(params.Object.Url)
