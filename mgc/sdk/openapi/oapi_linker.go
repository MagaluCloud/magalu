...
import (
	...
	"github.com/MagaluCloud/magalu/mgc/core/http"
...
func (l *openapiLinker) IsRemoveFromCLI() bool {
	return getRemoveFromCLIFlag(l.owner.extensionPrefix, l.link.Extensions)
}
