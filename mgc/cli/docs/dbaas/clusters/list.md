...
-h, --help                      help for list
    ...
    --status enum               Value referring to cluster status. (one of "ACTIVE", "BACKING_UP", "BALANCING", "CREATING", "DELETED", "DELETING", "ERROR", "ERROR_DELETING", "PENDING", "STARTING", "STOPPED" or "STOPPING")
