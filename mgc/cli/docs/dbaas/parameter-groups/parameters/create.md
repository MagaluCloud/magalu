...
-h, --help                          help for create
    --name enum                     EngineParametersMysql8 (one of "ACTIVATE_ALL_ROLES_ON_LOGIN", "AUTOCOMMIT", "AUTOMATIC_SP_PRIVILEGES", "BACK_LOG" or others...)
                                    Use --name=help for more details (required)
