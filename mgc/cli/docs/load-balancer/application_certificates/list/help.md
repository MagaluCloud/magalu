...
```bash
Usage:
  ./mgc load-balancer application-certificates list [load-balancer-id] [flags]
```
...
- --load-balancer-id string   load_balancer_id: ID of the load balancer to list the certificates for (required)
