...
Create Load Balancer ACL

## Usage:
```
mgc load-balancer network-acls create [load-balancer-id] [flags]
```

## Flags:
```
    --action enum                      AclActionType (one of "ALLOW", "DENY" or "DENY_UNSPECIFIED") (required)
