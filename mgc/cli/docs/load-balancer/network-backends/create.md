...
## Flags:
```
    --balance-algorithm enum        Balance Algorithm: The load balancing algorithm used by the backend (e.g., round_robin, least_connections) (one of "least_connections", "round_robin" or "source_ip_hash") (required)
...
-h, --help                          help for create
    ...
    --name string                   The unique name of the backend (required)
