...
## Usage:
```
mgc block-storage schedulers detach [id] [flags]
```

## Examples:
```
mgc block-storage schedulers detach --volume.id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" --volume.name="some_resource_name"
```
