...
Create a new project under the currently authenticated tenant

## Usage:
```
mgc project create [name] [flags]
```

## Examples:
```
mgc project create --name="my-project"
```

## Flags:
```
-h, --help          help for create
    --name string   Name of the new project (required)
```
