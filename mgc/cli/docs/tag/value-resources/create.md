...
## Usage:
```
mgc tag value-resources create [tag-name] [value-name] [flags]
```

## Examples:
```
mgc tag value-resources create --resource-id="31201f93-f5f4-4cf1-ba9c-bfed0717f4ac" --tag-name="kubernetes-expenses" --value-name="test-labs"
```
