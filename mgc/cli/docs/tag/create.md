...
Create a tag that can be attached to cloud resources.
...
## Examples:
```
mgc tag create --color="ffffff" --description="tag to monitor expenses with environments" --kinds='["finops"]' --name="kubernetes-expenses"
```
...
-h, --help                   help for create
    ...
    --values array(object)   Values to create along with the tag (at most 100 items)
