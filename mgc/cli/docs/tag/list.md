...
List all tags available to you.
...
## Examples:
```
mgc tag list --color="ffffff" --kinds='["finops"]'
```
...
-h, --help                     help for list
    ...
    --name string              Name of the tag to filter by (between 1 and 255 characters and pattern: ^[\w\ \-\[\]\(\)\.\:]+$)
```
