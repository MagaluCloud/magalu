...
```bash
Usage:
  ./mgc lbaas [network-loadbalancer-load-balancers] create [flags]
```

## Product catalog:
- Examples:
- ./mgc lbaas [network-loadbalancer-load-balancers] create --description="Some optional load balancer description" --name="nlb-1" --security-groups-ids='["00000000-0000-0000-0000-000000000000"]' --subnet-pool-id="00000000-0000-0000-0000-000000000000" --vpc-id="00000000-0000-0000-0000-000000000000"
