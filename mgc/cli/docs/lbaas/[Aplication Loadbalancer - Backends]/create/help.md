...
```bash
Usage:
  ./mgc lbaas [aplication-loadbalancer-backends] create [load-balancer-id] [flags]
```

## Product catalog:
- Examples:
- ./mgc lbaas [aplication-loadbalancer-backends] create --description="Some optional backend description 1" --health-check-name="alb-health-check-1" --name="alb-backend-1"
