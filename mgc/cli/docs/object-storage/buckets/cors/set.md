...
Set CORS document for the specified bucket. The CORS can be provided as a direct JSON string or a file path using @./cors.json.
...
## Flags:
```
    --cors object   CORS file path to be uploaded
