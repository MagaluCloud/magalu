...
$BASEDIR/add_specs_without_region.sh load-balancer lbaas mgc/spec_manipulator/cli_specs/conv.lbaas.openapi.yaml https://lbaas.jaxyendy.com/openapi-cli.json
