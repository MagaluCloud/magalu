...
$BASEDIR/add_specs_without_region.sh permissions permissions mgc/spec_manipulator/cli_specs/permissions.yaml https://permissions.jaxyendy.com/openapi-cli.json
