...
ERROR	magalu.cloud/sdk/blueprint.network.ports.security-group-attachment.create	failed to resolve blueprint references	{"name": "create", "description": "Attach a Security Group to a Port", "error": "parametersSchema: could not resolve \"/network/ports/attach\": missing field: \"attach\""}
